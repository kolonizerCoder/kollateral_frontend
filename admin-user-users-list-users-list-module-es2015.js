...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddUserModalComponent", function() { return AddUserModalComponent; });
...
let AddUserModalComponent = class AddUserModalComponent {
    constructor(router, main_services, modalController, navCtrl, loader) {
        this.router = router;
    ...
    get_roles() {
        this.main_services.getRolesList().subscribe((result) => {
    ...
    branch_name(e) {
        ...
        this.departmentsList = this.departments.filter((department) => {
    ...
    submit() {
        ...
        // return formData;
        this.main_services.addUserDetails(formData).subscribe((result) => {
            this.modalController.dismiss(result, 'success');
        }, (error) => {
            console.log(error);
            this.errMsg = error['error']['error']['name'];
            this.emailErr = error['error']['error']['email'];
            this.passworderr = error['error']['error']['password'];
            this.phoneErr = error['error']['error']['phone'];
            this.departmenterr = error['error']['error']['department'];
            this.rollerr = error['error']['error']['role'];
            this.brancherr = error['error']['error']['branch'];
            this.gendererr = error['error']['error']['gender'];
            if (this.errMsg) {
...
AddUserModalComponent.ctorParameters = () => [
...
AddUserModalComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-add-user-modal',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./add-user-modal.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/user/add-user-modal/add-user-modal.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./add-user-modal.component.scss */ "./src/app/admin/user/add-user-modal/add-user-modal.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditUserModalComponent", function() { return EditUserModalComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let EditUserModalComponent = class EditUserModalComponent {
    constructor(fb, route, router, main_serives, navParams, modalController, notificationService) {
        this.fb = fb;
        this.route = route;
        this.router = router;
    ...
    get_branches() {
        this.isLoading = true;
        this.main_serives.getBranchesList().subscribe((result) => {
            this.isLoading = false;
            this.branchesList = result['branches'];
        });
    }
    get_depts() {
        this.isLoading = true;
        this.main_serives.getDepartmentsList().subscribe((result) => {
            this.isLoading = false;
            this.departmentsList = result['departments'];
            this.departments = result['departments'];
        });
    ...
    get_roles() {
        this.isLoading = true;
        this.main_serives.getRolesList().subscribe((result) => {
            this.isLoading = false;
            this.rolesList = result['roles'];
        });
    }
    branch_name(e) {
        ...
        this.editUserForm.get('department').setValue('');
    ...
    ionViewWillEnter() {
        ...
        this.get_roles();
        this.isLoading = true;
        this.main_serives.getUserDetails(this.getId).subscribe((data) => {
            this.isLoading = false;
            this.userData = data['user'];
            this.checkWatsapp = data['user']['is_whatsapp_enabled'];
            this.imageData = data['user']['image'] ? data['user']['image'].url : '';
            this.isRole = data['user']['role']['name'];
            if (!this.userData.branch || this.userData.department) {
            ...
            this.editUserForm = this.fb.group({
                ...
                is_whatsapp_enabled: [this.userData.is_whatsapp_enabled],
                email: [this.userData.email],
                branch: [this.userData.branch ? this.userData.branch._id : ''],
                department: [this.userData.department ? this.userData.department._id : ''],
    ...
    editUser(value) {
        ...
        // return 0;
        this.main_serives.editUserDetails(this.getId, formData).subscribe((result) => {
            this.modalController.dismiss(result, 'success');
            this.main_serives.filter('click');
        }, (error) => {
            console.log(error);
            this.errName = error['error']['error']['name'];
            this.errPhone = error['error']['error']['phone'];
            this.errMail = error['error']['error']['email'];
            if (this.errName || this.errPhone || this.errMail) {
...
EditUserModalComponent.ctorParameters = () => [
...
EditUserModalComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-edit-user-modal',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./edit-user-modal.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/user/edit-user-modal/edit-user-modal.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./edit-user-modal.component.scss */ "./src/app/admin/user/edit-user-modal/edit-user-modal.component.scss")).default]
    })
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _users_list_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./users-list.page */ "./src/app/admin/user/users-list/users-list.page.ts");
...
/* harmony import */ var _users_list_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./users-list-routing.module */ "./src/app/admin/user/users-list/users-list-routing.module.ts");
/* harmony import */ var _users_list_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./users-list.page */ "./src/app/admin/user/users-list/users-list.page.ts");
...
/* harmony import */ var _add_user_modal_add_user_modal_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../add-user-modal/add-user-modal.component */ "./src/app/admin/user/add-user-modal/add-user-modal.component.ts");
/* harmony import */ var _edit_user_modal_edit_user_modal_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../edit-user-modal/edit-user-modal.component */ "./src/app/admin/user/edit-user-modal/edit-user-modal.component.ts");
...
/* harmony import */ var _services_main_services_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../../../services/main-services.service */ "./src/app/services/main-services.service.ts");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _add_user_modal_add_user_modal_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../add-user-modal/add-user-modal.component */ "./src/app/admin/user/add-user-modal/add-user-modal.component.ts");
/* harmony import */ var _edit_user_modal_edit_user_modal_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../edit-user-modal/edit-user-modal.component */ "./src/app/admin/user/edit-user-modal/edit-user-modal.component.ts");
...
let UsersListPage = class UsersListPage {
    constructor(main_services, router, modalController, alertCtrl, toastr) {
        this.main_services = main_services;
        this.router = router;
        this.modalController = modalController;
    ...
    ionViewWillEnter() {
        ...
        this.setupData = [];
        this.isLoading = true;
        this.main_services.getUsersList().subscribe((result) => {
            this.isLoading = false;
    ...
    paginationData(pageNo) {
        this.setupData = [];
        this.isLoading = true;
        this.main_services.userPagination(pageNo).subscribe((result) => {
            this.isLoading = false;
            this.page = result['page'];
            result['users'].forEach((data) => {
                this.setupData.push({
    ...
    delete_user(id) {
        this.isLoading = true;
        this.main_services.deleteUserDetails(id).subscribe((data) => {
            this.isLoading = false;
    ...
    user_search(searchData) {
        this.isLoading = true;
        this.main_services.searchuserApi(searchData).subscribe((data) => {
            this.isLoading = false;
            this.setupData = [];
...
UsersListPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./users-list.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/user/users-list/users-list.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./users-list.page.scss */ "./src/app/admin/user/users-list/users-list.page.scss")).default]
    })
], UsersListPage);
...
//# sourceMappingURL=admin-user-users-list-users-list-module-es2015.js.map